...
class HomeprogressUser extends StatefulWidget {
  @override
  _HomeprogressUserState createState() => _HomeprogressUserState();
}

class _HomeprogressUserState extends State<HomeprogressUser> {
